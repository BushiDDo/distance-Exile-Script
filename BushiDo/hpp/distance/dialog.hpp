...
class TAW_VD 
{
	...
	class controls 
	{
		class Title : TAWVD_RscTitle {
			colorBackground[] = {0, 0, 0, 0};
			idc = -1;
			text = "Настройки Дальности Обзора";
			x = 0.3;
			y = 0.2;
			w = 0.8;
			h = (1 / 25);
		...
		class VD_onfoot_slider : TAWVD_RscXSliderH 
		{
			...
			tooltip = "Посмотреть расстояние в то время как пешком";
			x = 0.46;
			y = 0.30 - (1 / 25);
		...
		class VD_car_slider : TAWVD_RscXSliderH 
		{
			...
			tooltip = "Посмотреть расстояние в то время как в наземном транспортном средстве";
			x = 0.46;
			y = 0.35 - (1 / 25);
		...
		class VD_air_slider : TAWVD_RscXSliderH 
		{
			...
			tooltip = "Посмотреть расстояние в то время как в воздухе автомобиля";
			x = 0.46;
			y = 0.40 - (1 / 25);
